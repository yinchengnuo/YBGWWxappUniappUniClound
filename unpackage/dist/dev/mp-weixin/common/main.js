...
/* harmony import */ var _D_HBuilderXAlpha_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/runtime/componentNormalizer.js */ 20);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _add_good_vue_vue_type_template_id_7ea104a8_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-good.vue?vue&type=template&id=7ea104a8&scoped=true& */ 29);
/* harmony import */ var _add_good_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-good.vue?vue&type=script&lang=js& */ 31);
...
var _list = _interopRequireDefault(__webpack_require__(/*! @/mixin/list.js */ 41));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var goodItem = function goodItem() {return __webpack_require__.e(/*! import() | components/good-item */ "components/good-item").then(__webpack_require__.bind(null, /*! @/components/good-item.vue */ 94));};var pulldownRefresher = function pulldownRefresher() {return __webpack_require__.e(/*! import() | components/pulldown-refresher */ "components/pulldown-refresher").then(__webpack_require__.bind(null, /*! @/components/pulldown-refresher.vue */ 101));};var _default =
...

{
  ...
  mixins: [_nav.default, _list.default],
  components: { goodItem: goodItem, pulldownRefresher: pulldownRefresher },
  data: function data() {
    return {
  ...
  mounted: function mounted() {var _this = this;
    uni.$on('REFRESH2', function () {return _this.$refs.pulldownRefresher.pulldown();});
  },
  methods: {
    refresh: function refresh() {var _this2 = this; // 下拉刷新（请求数据）
      uni.showLoading({ mask: true, title: '加载中...' });
      uniCloud.callFunction({ name: 'good-R', data: { type: 2 } }).then( /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref) {var result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:result = _ref.result;
                  _this2.$refs.pulldownRefresher.pullup();
                  _this2.lists[0] = result[0];
                  uni.hideLoading();_context.next = 6;return (
                    new Promise(function (resolve) {return setTimeout(function () {return resolve();}, 567);}));case 6:
                  _this2.lists[1] = result[1];_context.next = 9;return (
                    new Promise(function (resolve) {return setTimeout(function () {return resolve();}, 567);}));case 9:
                  _this2.lists[2] = result[2];_context.next = 12;return (
                    new Promise(function (resolve) {return setTimeout(function () {return resolve();}, 567);}));case 12:
                  _this2.lists[3] = result[3];_context.next = 15;return (
                    new Promise(function (resolve) {return setTimeout(function () {return resolve();}, 567);}));case 15:
                  _this2.lists[4] = result[4];case 16:case "end":return _context.stop();}}}, _callee, this);}));return function (_x) {return _ref2.apply(this, arguments);};}());
...

{
  ...
  mounted: function mounted() {var _this = this;
    uni.$on('REFRESH1', function (noLoading) {return _this.$refs.pulldownRefresher.pulldown(noLoading);});
  },
  methods: {
    refresh: function refresh(noLoading) {var _this2 = this; // 下拉刷新（请求数据）
      !noLoading && uni.showLoading({ mask: true, title: '加载中...' });
      uniCloud.callFunction({ name: 'good-R', data: { type: 1 } }).then( /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref) {var result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:result = _ref.result;
                  _this2.$refs.pulldownRefresher.pullup();
                  _this2.lists[0] = result[0];
                  uni.hideLoading();_context.next = 6;return (
                    new Promise(function (resolve) {return setTimeout(function () {return resolve();}, 567);}));case 6:
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _login_vue_vue_type_template_id_4b1fcd48_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.vue?vue&type=template&id=4b1fcd48&scoped=true& */ 66);
...
/* harmony import */ var _login_vue_vue_type_style_index_0_id_4b1fcd48_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.vue?vue&type=style&index=0&id=4b1fcd48&lang=scss&scoped=true& */ 70);
/* harmony import */ var _D_HBuilderXAlpha_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/runtime/componentNormalizer.js */ 20);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shengxian_vue_vue_type_template_id_b5e34ad0___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shengxian.vue?vue&type=template&id=b5e34ad0& */ 73);
/* harmony import */ var _shengxian_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shengxian.vue?vue&type=script&lang=js& */ 75);
...
/* harmony import */ var _shengxian_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shengxian.vue?vue&type=style&index=0&lang=scss& */ 77);
/* harmony import */ var _D_HBuilderXAlpha_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/runtime/componentNormalizer.js */ 20);
...

{
  ...
  mounted: function mounted() {var _this = this;
    uni.$on('REFRESH3', function () {return _this.$refs.pulldownRefresher.pulldown();});
  },
  methods: {
    refresh: function refresh() {var _this2 = this; // 下拉刷新（请求数据）
      uni.showLoading({ mask: true, title: '加载中...' });
      uniCloud.callFunction({ name: 'good-R', data: { type: 3 } }).then( /*#__PURE__*/function () {var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref) {var result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:result = _ref.result;
                  _this2.$refs.pulldownRefresher.pullup();
                  _this2.lists[0] = result[0];
                  uni.hideLoading();_context.next = 6;return (
                    new Promise(function (resolve) {return setTimeout(function () {return resolve();}, 567);}));case 6:
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wode_vue_vue_type_template_id_9b64e2b0___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./wode.vue?vue&type=template&id=9b64e2b0& */ 80);
/* harmony import */ var _wode_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./wode.vue?vue&type=script&lang=js& */ 82);
...
/* harmony import */ var _wode_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./wode.vue?vue&type=style&index=0&lang=scss& */ 84);
/* harmony import */ var _D_HBuilderXAlpha_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/runtime/componentNormalizer.js */ 20);
