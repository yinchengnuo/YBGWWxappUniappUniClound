...
var _default =
{
  ...
  methods: {
    ...
    addGood: function () {var _addGood = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _this3 = this;var _ref3, url;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (
                ...
                uni.showLoading({ mask: true, title: '添加中...' });_context.next = 15;return (
                  uniCloud.uploadFile({ filePath: this.imgList[0] }));case 15:_ref3 = _context.sent;url = _ref3.fileID;
                ...
                });case 18:case "end":return _context.stop();}}}, _callee, this);}));function addGood() {return _addGood.apply(this, arguments);}return addGood;}() } };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"], __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js */ 12)["default"]))
...
//
var goodItem = function goodItem() {return Promise.all(/*! import() | components/good-item */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/good-item")]).then(__webpack_require__.bind(null, /*! @/components/good-item.vue */ 86));};var pulldownRefresher = function pulldownRefresher() {return __webpack_require__.e(/*! import() | components/pulldown-refresher */ "components/pulldown-refresher").then(__webpack_require__.bind(null, /*! @/components/pulldown-refresher.vue */ 93));};var _default = { onShareAppMessage: function onShareAppMessage() {//分享小程序
    return { title: '益百购物欢迎您！', path: '/pages/fushi/fushi' };}, mixins: [_nav.default, _list.default], components: { goodItem: goodItem, pulldownRefresher: pulldownRefresher }, data: function data() {return { navList: ['蔬菜', '水果', '干货', '冷冻', '调料'], lists: [] };}, mounted: function mounted() {var _this = this;uni.$on('REFRESH3', function () {return _this.$refs.pulldownRefresher.pulldown();});}, methods: { refresh: function refresh() {var _this2 = this; // 下拉刷新（请求数据）
